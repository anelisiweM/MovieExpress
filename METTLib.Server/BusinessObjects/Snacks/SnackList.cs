...
namespace MELib.Snacks
{
     ...
     : SingularBusinessListBase<SnackList, Snack>
    {
        ...
        public static SnackList GetSnackListSnackID(int? SnackTypeID)
        {
            return DataPortal.Fetch<SnackList>(new Criteria() { snackTypeID=SnackTypeID });
        }
            ...
            using (SqlConnection cn = new SqlConnection(Singular.Settings.ConnectionString))
            {
                ...
                try
                {
                    using (SqlCommand cm = cn.CreateCommand())
                    {
                        ...
                        cm.CommandText = "GetProcs.getSnackList1";
