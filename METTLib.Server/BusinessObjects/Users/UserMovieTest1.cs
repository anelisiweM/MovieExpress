...
{
    [Serializable]
    public class UserMovieTest1
     : SingularBusinessBase<UserMovieTest1>
    {
        ...
        public override string ToString()
        {
            if (this.CreatedDate.ToString().Length == 0)
            {
                if (this.IsNew)
                {
                    return String.Format("New {0}", "User Movie Test 1");
                }
                else
                {
                    return String.Format("Blank {0}", "User Movie Test 1");
                }
            }
            else
            {
        ...
        protected override void OnCreate()
        {
            ...
            // Set any variables here, not in the constructor or NewUserMovieTest1() method.
        }

        public static UserMovieTest1 NewUserMovieTest1()
        {
            return DataPortal.CreateChild<UserMovieTest1>();
        }

        public UserMovieTest1()
        {
            MarkAsChild();
        }

        internal static UserMovieTest1 GetUserMovieTest1(SafeDataReader dr)
        {
            var u = new UserMovieTest1();
            u.Fetch(dr);
            return u;
        }
