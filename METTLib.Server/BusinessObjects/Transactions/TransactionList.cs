// Generated 12 Nov 2021 09:06 - Singular Systems Object Generator Version 2.2.694
//<auto-generated/>
using System;
using Csla;
...
namespace MELib.Transactions
{
     ...
     : SingularBusinessListBase<TransactionList, Transaction>
    {
        ...
        public static TransactionList GetTransactionListID(int UserID)
        {
            return DataPortal.Fetch<TransactionList>(new Criteria() { UserID = UserID });
        }

        public static TransactionList GetTransactionListOrder(int UserID, int OrderID)
        {
            return DataPortal.Fetch<TransactionList>(new Criteria() { UserID = UserID, OrderID = OrderID });
        }
