                      ...
                      var LeftColRight = RowContentDiv.Helpers.DivC("col-md-9");
                      {
                          ...
                          var AnotherCardDiv = LeftColRight.Helpers.DivC("ibox float-e-margins paddingBottom");
                          {
                              var CardTitleDiv = AnotherCardDiv.Helpers.DivC("ibox-title");
                              {
                                  ...
                                  var SnacksDiv = CardTitleDiv.Helpers.BootstrapTableFor<MELib.Users.User>((c) => c.UserList, false, false, "");
                                  {
                                      var FirstRow = SnacksDiv.FirstRow;
                                      {
                                          var SnackTitle = FirstRow.AddColumn("Title");
                                          {
                                              var SnackTitleText = SnackTitle.Helpers.EditorFor(c => c.FirstName);
