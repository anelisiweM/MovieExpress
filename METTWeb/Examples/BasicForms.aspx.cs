...
namespace MEWeb.Examples
{
  ...
  public class BasicFormsVM : MEStatelessViewModel<BasicFormsVM>
  {
    public MELib.Movies.Movie EditMovie { get; set; }
        public MELib.Snacks.Snack EditSnack { get; set; }
    ...
    protected override void Setup()
    {
      base.Setup();
            ...
            EditSnack = MELib.Snacks.SnackList.GetSnackList().FirstOrDefault();
    }
    ...
    public static Result GetMovie(int MovieID)
    {
      ...
      return sr;
        ...
        [WebCallable]
        public static Result GetSnacks(int SnackID)
        {
            Result sr = new Result();
            try
            {
    ...
    public static Result DeleteMovie(int MovieID)
    {
     ...
     // MovieToRemove.TrySave();
      ...
      return sr;
        ...
        [WebCallable]
        public static Result DeleteSnack(int SnackID)
        {
            Result sr = new Result();
            try
            {
                ...
                MELib.Snacks.SnackList SnackList = MELib.Snacks.SnackList.GetSnackList();
                SnackList.ToList().ForEach(c => { c.IsActiveInd = false; });
                SnackList.TrySave();
