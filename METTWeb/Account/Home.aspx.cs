...
namespace MEWeb.Account
{
  public partial class Home : MEPageBase<HomeVM>
  {
    ...
    public class HomeVM : MEStatelessViewModel<HomeVM>
    {
        ...
        public MELib.Users.UserList UserList1 { get; set; }
        public MELib.Users.User User1 { get; set; }
    ...
    protected override void Setup()
    {
      base.Setup();
            ...
            UserList1 = MELib.Users.UserList.GetUserList();
     ...
     UserList = MELib.RO.ROUserList.GetROUserListID(UserID);
            ...
            User1 = UserList1.FirstOrDefault();
