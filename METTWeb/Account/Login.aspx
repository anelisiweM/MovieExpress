  ...
  <%
      using (var h = this.Helpers)
      {
          ...
          var ForgotPasswordDiv = h.Div();
          {
              ...
              var register = LoginDiv.Helpers.HTMLTag("label", "Not Yet Registered?");
                    {
              {

                          var Registerbutton = LoginDiv.Helpers.Button("Register", Singular.Web.ButtonMainStyle.Primary, Singular.Web.ButtonSize.Normal, Singular.Web.FontAwesomeIcon.None);
                                                {
                                                    Registerbutton.AddBinding(Singular.Web.KnockoutBindingString.click, "Register($data)");
                                                }

                  Registerbutton.AddBinding(Singular.Web.KnockoutBindingString.click, "Register()");
